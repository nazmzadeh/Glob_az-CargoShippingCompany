        ...
        <div className="steps">
          <div className="how_to_order step">
            ...
            <div className="text">
              ...
              <p>Məhsulu seçin, Ödəniş edin, Məhsulu biz alırıq. </p>-
              <a href='#'>Daha çox..</a>
            </div>
          </div>
          ...
          <div className="delivery step">
            ...
            <div className="text">
              <h5>Çatdırılma</h5>
              <p>Bağlama Türkiyə anbarına qəbul edilir. Yüklər qablaşdırılır və  Azərbaycana göndərilir. Bakı ofisindən bağlamalar təhvil verilir. </p>-
              <a href='#'>Daha çox..</a>
            </div>
          </div>
        </div>
